...
public class MultiEndpoints {
    @Command(desc = "Check for multi accounts attached to a nation", viewable = true)
    ...
    @Command(desc = "Advanced multi detection report with detailed analysis", viewable = true)
