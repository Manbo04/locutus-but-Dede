...
ENABLED_COMPONENTS:
  ...
  WEB: true
  REPEATING_TASKS: ${REPEATING_TASKS:-true}
  SUBSCRIPTIONS: true
  EVENTS: true
  PROXY: false
  SNAPSHOTS: ${SNAPSHOTS:-true}

# Task intervals (set to 0 to disable)
TASKS:
  NATION_CITY_UPDATE_INTERVAL: ${NATION_CITY_UPDATE_INTERVAL:-600}
  TREATY_UPDATE_SECONDS: ${TREATY_UPDATE_SECONDS:-600}
  TREASURE_UPDATE_SECONDS: ${TREASURE_UPDATE_SECONDS:-600}
  ALL_NATIONS_SECONDS: ${ALL_NATIONS_SECONDS:-600}
