...
# The database directory is where SQLite files are stored
# This will be the mount point for Railway's persistent volume
RUN mkdir -p /app/database /app/data /data
